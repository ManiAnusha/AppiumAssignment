...
public class BaseTest {
	...
	public void setup(String platformName, String udid, String deviceName) throws AppiumServerHasNotBeenStartedLocallyException, Exception {
		...
		System.out.println("Before-Config1");
		inputStream = getClass().getClassLoader().getResourceAsStream("config.properties");
		System.out.println("Before-Config2");
		...
		System.out.println("Before-Config3");
		if(!checkIfAppiumServerIsRunnning(4723)) {
			System.out.println("Before-appium");
			server.start();
			System.out.println("after-appium");
	...
	public AppiumDriverLocalService getAppiumServerDefault() {
		System.out.println("I am in WIndows Appium");
